...
class MapUI {
    ...
    enableDragCanvas() {
        ...
        mapContainer.addEventListener('pointermove', (event) => {
            ...
            const deltaX = event.clientX - parseFloat(mapContainer.dataset.startX || '0');
            const deltaY = event.clientY - parseFloat(mapContainer.dataset.startY || '0');
            ...
            island.addEventListener('click', (e) => {
                ...
                if (missionId === 'lab') {
                    if (this.labUnlocked) {
                        ...
                        window.popupSystem.showFeedback('تحتاج 4 مفاتيح لفتح معمل الابتكار!', 'error');
                    }
